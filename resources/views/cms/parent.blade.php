...
<head>
    ...
    <title>Professions System | @yield('main-title')</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-header">Settigs</li>
                        <li class="nav-item">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2020-2021 <a href="#">{{ env('APP_NAME') }}</a>.</strong> All rights
            reserved.
        </footer>
